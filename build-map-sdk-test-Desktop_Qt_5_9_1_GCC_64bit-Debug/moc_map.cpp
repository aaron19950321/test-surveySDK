...
QT_MOC_LITERAL(1, 4, 11), // "replayReady"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 10), // "replaySlot"
QT_MOC_LITERAL(4, 28, 14), // "QNetworkReply*"
QT_MOC_LITERAL(5, 43, 5), // "reply"
QT_MOC_LITERAL(6, 49, 3), // "get"
QT_MOC_LITERAL(7, 53, 3) // "url"

    },
    "Map\0replayReady\0\0replaySlot\0QNetworkReply*\0"
    "reply\0get\0url"
};
...
void Map::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->replayReady(); break;
        case 1: _t->replaySlot((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 2: _t->get((*reinterpret_cast< QUrl(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Map::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Map::replayReady)) {
                *result = 0;
                return;
            }
        }
